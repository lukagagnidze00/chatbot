...
📍 *Address:* 42 Zakaria Paliashvili Street / 6 Dimitri Araqishvili Street, Tbilisi, Georgia, 0179  
🎒 *Grades:* 1-12    
👩‍🏫 *Teachers:* Highly qualified & caring professionals  
👨‍👩‍👧‍👦 *Class Size:* groups of up to 20 students
📘 *Curriculum:* National & British International (Pearson Edexcel)
🎯 *School activities:* Football, chess, traditional dances, hip-hop, ballet, music, visual arts🎨, and handicrafts. (price included)
🎯 *After-school Advanced Clubs:* Robotics, chess, mental arithmetic, software development, advanced sports 🏀⚽️🏐, comics, theatre, literature club, speech and reasoning club, mythology, journalism, visual arts🎨, Guitar lessons🎸 (price excluded)   
...
📍 *მისამართი:* ზაქარია ფალიაშვილის ქ. 42 / დიმიტრი არაყიშვილის ქ. 6, თბილისი, საქართველო, 0179
🎒 *კლასები:* I-დან XII-მდე
👩‍🏫 *მასწავლებლები:* კვალიფიციური და მზრუნველი პროფესიონალები
👨‍👩‍👧‍👦 *კლასის ზომა:* ჯგუფები 20-მდე მოსწავლით
📘 *სასწავლო პროგრამა:* ეროვნული და ბრიტანული საერთაშორისო (Pearson Edexcel)
🎯 *სასკოლო აქტივობები:* ფეხბურთი, ჭადრაკი, ტრადიციული ცეკვები, ჰიპ-ჰოპი, ბალეტი, მუსიკა, ხატვა, ხელსაქმე (ფასში შედის)
🎯 *დამატებითი კლუბები:* რობოტექნიკა, ჭადრაკი, მენტალური არითმეტიკა, პროგრამირება, სპორტული წრეები 🏀⚽️🏐, კომიქსები, თეატრალური, ლიტერატურული, მეტყველების და აზროვნების კლუბი, მითების სამყარო, ჟურნალისტიკა, ხატვა, გიტარა (ფასში არ შედის) 🧠
...
📍 *Address:* 42 Zakaria Paliashvili Street / 6 Dimitri Araqishvili Street, Tbilisi, Georgia, 0179  
👶 *Ages:* 5 – 6 years  
👨‍👩‍👧‍👦 *Group Size:* groups of up to 14 students
...
📍 *მისამართი: ზაქარია ფალიაშვილის ქ. 42 / დიმიტრი არაყიშვილის ქ. 6, თბილისი, საქართველო, 0179
👶 *ასაკი:* 5-6 წელი
🧑‍🧑‍🧒‍🧒 *ჯგუფის ზომა:* ჯგუფები 14-მდე მოსწავლით
