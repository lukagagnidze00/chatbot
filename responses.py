...
welcome = 
"""*გამარჯობა*, კეთილი იყოს თქვენი მობრძანება *რობერ შუმანის ევროპულ სასწავლებელ პროგრამა \"მოძღვარის\"* ჩატში! გთხოვთ, აირჩიეთ ენა და მიყევით ჩატბოტს სასურველი ინფორმაციის მისაღებად🎓. 
ჩატის ხელახლა დასაწყებად აკრიფეთ სიტყვა: *restart*.
